...
export default function GettingStarted() {
  return (
    <main>
      ...
      <p>
        The nitrogql CLI can be installed with npm. The CLI is required for any
        workflow using nitrogql. Since generated types depend on{" "}
        <a
...
documents: ./app/**/*.graphql`}
      ...
      <h3>Setting up GraphQL loader for webpack</h3>
      <p>
  ...
  rules: [
    // ...
    {
      ...
      <h3>Setting up GraphQL loader for Rollup</h3>
      <p>
...
`}
      ...
      <h3>Statically checking GraphQL files</h3>
      <p>
        In the following explanations, we will assume that GraphQL schemas and
        operations are already prepared. If you are new to GraphQL, it is a good
        idea to check out{" "}
        <a
          href="https://github.com/uhyo/nitrogql/tree/master/examples/vite"
          target="_blank"
      ...
      <Hint>
        ...
        <code>graphql.config.yaml</code> in the current directory by default. To
        specify the location of the configuration file, use the{" "}
      ...
      <Hint>
        ...
        configure nitrogql to generate <code>.graphql.d.ts</code> files instead.
        See <Link href="/configuration">Configuration</Link> for details.
      </Hint>
      <p>
...
extensions:
  nitrogql:
    generate:
      ...
      <p>
        To generate TypeScript types, run the following command in your project
        directory:
      </p>
      ...
      <p>
        Now you can import <code>.graphql</code> files in your TypeScript code,
        but probably you need to adjust your <code>tsconfig.json</code> so that
        TypeScript allows importing <code>.graphql</code> files.
      </p>
...
export function SampleComponent() {
  ...
  return <div>{data?.sample}</div>;
      ...
      <p>
        Of course this is type-safe. If your code accesses a field that does not
        exist in the schema, TypeScript will report an error.
      </p>
      <Hint>
