  ...
  return (
    <Toc>
      <main>
        ...
        <p>
          nitrogql provides a CLI to check your GraphQL code and to generate
          types from your schema and operations.
        </p>
        <p>
        ...
        <ul>
          ...
          <li>
            <code>generate</code>: Generate types from your schema and
            operations.
          </li>
        </ul>
        <Hint>
        ...
        <p>
          Specify the path to the operation file(s). This overrides the
          operation path specified in the configuration file.
        </p>
        ...
        <ul>
          <li>
            <code>human</code> (default): prints human-readable output to
            stderr.
          </li>
          <li>
            ...
            format to stdout. This is useful for integrating with reviewdog.
            Makes sense only when the <code>check</code> command is run.
          </li>
          <li>
  ...
  generate?: {
    ...
    files: { 
      ...
      path: string;
        ...
        <h3 id="notes-on-file-system-access">Notes on file system access</h3>
        <p>
          Due to the security nature of WASI, the CLI cannot access files
          outside the current directory by default. To allow access to files
          outside the current directory, use a <code>NITROGQL_FS_SCOPE</code>{" "}
