    ...
    <Toc>
      <main>
        ...
        <p>
          ...
          Introspection result of the API is contained in the project and is
          used as a schema definition.
        </p>
        <p>
        ...
        <p>
          If you have a use case that is not covered by the examples above,
          please let us know! Also please check out{" "}
          <Link href="/">Top Page</Link> for planned features.
        </p>
      </main>
    </Toc>
  );
